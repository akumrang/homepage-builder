...
다음 1순위 추천 작업은 가상 파일럿 발송 리허설이다. 실제 고객 발송이 아니라, 가상 학원 정보를 넣어 발송 문안과 내부 범위 분리가 자연스럽게 작동하는지 확인한다.
