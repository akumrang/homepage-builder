...
커밋 후 다음 추천 작업은 샘플 방향 3종 브리프 작성이다. 이 작업도 구현이 아니라 `trust-basic-v1`, `exam-focus-v1`, `small-group-v1` 후보의 목적, 필수 섹션, 필요한 자료, 금지 문구, 운영 난이도를 정리하는 단계다.
