...
| 내부 정적 샘플 자료 상담 리허설 체크리스트 | 다음 기획 후보 | 실제 고객에게 보여주기 전, 자료 흐름과 기대 관리 문구가 충분한지 내부 리허설로 점검해야 한다. |
...
- 다음은 해당 자료 기준의 상담 리허설 체크리스트를 정리한다.
...
1. 내부 정적 샘플 자료 기준의 상담 리허설 체크리스트 작성
